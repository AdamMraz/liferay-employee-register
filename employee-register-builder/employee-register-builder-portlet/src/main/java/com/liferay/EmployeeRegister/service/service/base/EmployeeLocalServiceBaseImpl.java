...
import com.liferay.EmployeeRegister.service.service.EmployeeLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.EmployeeRegister.service.service.impl.EmployeeLocalServiceImpl}.
 * </p>
 *
...
public abstract class EmployeeLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    @BeanReference(type = com.liferay.EmployeeRegister.service.service.BankLocalService.class)
    protected com.liferay.EmployeeRegister.service.service.BankLocalService bankLocalService;
    @BeanReference(type = BankPersistence.class)
    protected BankPersistence bankPersistence;
    @BeanReference(type = com.liferay.EmployeeRegister.service.service.EmployeeLocalService.class)
    protected com.liferay.EmployeeRegister.service.service.EmployeeLocalService employeeLocalService;
    @BeanReference(type = EmployeePersistence.class)
    protected EmployeePersistence employeePersistence;
    @BeanReference(type = com.liferay.EmployeeRegister.service.service.PositionLocalService.class)
    protected com.liferay.EmployeeRegister.service.service.PositionLocalService positionLocalService;
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.liferay.EmployeeRegister.service.service.EmployeeLocalServiceUtil} to access the employee local service.
     */
    ...
    public void addBankEmployee(long bankId, long employeeId)
        throws SystemException {
        bankPersistence.addEmployee(bankId, employeeId);
    }
     ...
     */
    @Override
    public void addBankEmployee(long bankId, Employee employee)
        throws SystemException {
        bankPersistence.addEmployee(bankId, employee);
    }
    ...
    public void addBankEmployees(long bankId, long[] employeeIds)
        throws SystemException {
        bankPersistence.addEmployees(bankId, employeeIds);
    }
     ...
     */
    @Override
    public void addBankEmployees(long bankId, List<Employee> Employees)
        throws SystemException {
        bankPersistence.addEmployees(bankId, Employees);
    }
     ...
     */
    @Override
    public void clearBankEmployees(long bankId) throws SystemException {
        bankPersistence.clearEmployees(bankId);
    }
    ...
    public void deleteBankEmployee(long bankId, long employeeId)
        throws SystemException {
        bankPersistence.removeEmployee(bankId, employeeId);
    }
     ...
     */
    @Override
    public void deleteBankEmployee(long bankId, Employee employee)
        throws SystemException {
        bankPersistence.removeEmployee(bankId, employee);
    }
    ...
    public void deleteBankEmployees(long bankId, long[] employeeIds)
        throws SystemException {
        bankPersistence.removeEmployees(bankId, employeeIds);
    }
     ...
     */
    @Override
    public void deleteBankEmployees(long bankId, List<Employee> Employees)
        throws SystemException {
        bankPersistence.removeEmployees(bankId, Employees);
    }
     ...
     */
    @Override
    public List<Employee> getBankEmployees(long bankId)
        throws SystemException {
        return bankPersistence.getEmployees(bankId);
    }
     ...
     */
    @Override
    public List<Employee> getBankEmployees(long bankId, int start, int end)
        throws SystemException {
        return bankPersistence.getEmployees(bankId, start, end);
    }
     ...
     */
    @Override
    public int getBankEmployeesCount(long bankId) throws SystemException {
        return bankPersistence.getEmployeesSize(bankId);
    }
    ...
    public boolean hasBankEmployee(long bankId, long employeeId)
        throws SystemException {
        return bankPersistence.containsEmployee(bankId, employeeId);
    }
     ...
     */
    @Override
    public boolean hasBankEmployees(long bankId) throws SystemException {
        return bankPersistence.containsEmployees(bankId);
    }
    ...
    public void setBankEmployees(long bankId, long[] employeeIds)
        throws SystemException {
        bankPersistence.setEmployees(bankId, employeeIds);
    }
     ...
     */
    public com.liferay.EmployeeRegister.service.service.BankLocalService getBankLocalService() {
    ...
    public void setBankLocalService(
        com.liferay.EmployeeRegister.service.service.BankLocalService bankLocalService) {
     ...
     */
    public com.liferay.EmployeeRegister.service.service.EmployeeLocalService getEmployeeLocalService() {
    ...
    public void setEmployeeLocalService(
        com.liferay.EmployeeRegister.service.service.EmployeeLocalService employeeLocalService) {
     ...
     */
    public com.liferay.EmployeeRegister.service.service.PositionLocalService getPositionLocalService() {
    ...
    public void setPositionLocalService(
        com.liferay.EmployeeRegister.service.service.PositionLocalService positionLocalService) {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.liferay.EmployeeRegister.service.model.Employee",
